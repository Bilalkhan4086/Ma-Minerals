...
const packages_details = ({ nameOfGem, secondaryDecs, headingDecsOfGem, imageOfGem, decsOfGem, DescHeading }) => {
    const styles = {
        smallBox: {
            color: "#002a4c",
        ...
        <Box sx={styles.mainBox}>
            ...
            <Box sx={styles.mainHeadingBox}>
                <Heading sx={styles.mainHeading}>
                    {nameOfGem === undefined ? "Crystal Tumrin" : nameOfGem}
                </Heading>
                <Text sx={{ ...styles.mainHeading, ...{ fontSize: "18px" } }}>{headingDecsOfGem === undefined ? "Precious Tumrin found in Pakistan" : headingDecsOfGem}</Text>
            </Box>
