...
const links = [{name:"whatsapp",link:"/#"},{name:"google",link:"/#"},{name:"twitter",link:"/#"},{name:"facebook",link:"/#"},{name:"instagram",link:"/#"}]
    ...
    <Box>
        ...
        <Box sx={styles.medBox}>
            ...
            <InsightInfoCard Icon={PeopleAltIcon} detail="Our Resounces" number={59}/>
            <InsightInfoCard Icon={TaskIcon} detail="Mining Complete" number={32}/>
            <InsightInfoCard Icon={AccessTimeFilledIcon} detail="New proposals" number={2}/>
            <InsightInfoCard Icon={AutoGraphIcon} detail="Work Charm" number={"95%"}/>
