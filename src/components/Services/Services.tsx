...
const styles={
    ...
    buttonStyle:{
        background: "linear-gradient(90deg, #cbaf22, #3a668a 51%, #cbaf22) var(--x, 0)/ 200%",
        borderRadius:"30px",
        height:"50px",
        fontFamily:"Montserrat,sans-serif",
        fontSize:"16px",
  ...
  return (
    <Box sx={styles.mainBox}>
        ...
        <Box sx={styles.smallLine2}>.</Box>
            ...
            <Card icon={icon1} heading={"Gold Mining"} description={"Gold mining is the extraction of gold resources by mining. Historically"}/>
            <Card icon={icon2} heading={"Gems Mining"} description={"The mining techniques adopted to extract gemstones invariably"}/>
            <Card icon={icon3} heading={"Copper Mining"} description={"Copper mining is usually performed using open-pit mining,"}/>
            <Card icon={icon4} heading={"Mineral Mining"} description={"In a surface mine, hard rock must be drilled and blasted, Some"}/>
            </Box>
