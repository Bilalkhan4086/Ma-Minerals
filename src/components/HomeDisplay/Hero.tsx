    ...
    <Box sx={styles.mainBox}>
      .<Box sx={styles.subBox}>
        ...
        <Box sx={styles.leftBox}>
          <Box><Heading sx={styles.mainHeading}>
            Diging And Minings 
          </Heading>
        ...
        <Box sx={styles.headingSeperator}>
          <Text style={{ fontStyle: "italic",color:"#cbaf22" }}>Just Reach For Your Phone</Text>
          <Heading sx={styles.callBox}>
            Call us On +92 344 8884 086, 304 5665 065
          </Heading>
        </Box>
        <Box>
        ...
        {/* Right */}
          <Box sx={{"@media (max-width:380px)":{display:"flex",justifyContent:"center"}}}>
