  ...
  return (
    <Box sx={styles.mainBox}>
      ...
      <Box sx={styles.leftSide}>
        <Box>
          <Text sx={styles.smallHeading}>Ore Processing</Text>
          <Box sx={styles.underline}>
            <Box sx={styles.smallBox} >.</Box>
            <Box sx={styles.smallLine}>.</Box>
          </Box>
          <Box>
            <Heading sx={styles.headingLeft}>We Write About Mining Mines</Heading>
      ...
      <Box>
        <Box sx={styles.RightSide}>
          <Box className='card1' sx={styles.CardBox}>
            ...
            <Heading sx={styles.CardHeading}>Gold Mining</Heading>
